...
{
    // default connection
    public static $dbname = 'infinityx'; // Your database name
    ...
    public static $alt_encription_key = '$#%#fdshdghu%$5356534hRTRY56757'; // needs to protect alt. session data, required if alt. session is enabled
    ...
    public static $enable_search = false; // show searck block
    ...
    public static $plugins_uri = 'vendor/xcrud/plugins'; // scripts and libraries
    public static $themes_uri = 'vendor/xcrud/themes'; // css, images
    public static $lang_uri = 'vendor/xcrud/languages'; // js files
    public static $ajax_uri = 'api/xcrud_ajax'; // main ajax file or url
