<?php
$path = FCPATH . 'vendor'.DIRECTORY_SEPARATOR.'FPDI'.DIRECTORY_SEPARATOR.'vendor'.DIRECTORY_SEPARATOR.'setasign'.DIRECTORY_SEPARATOR.'fpdf'.DIRECTORY_SEPARATOR;
...
{
    // Logo
    $this->Image(FCPATH.'images/logo-24bit.png',10,3,30);
    // Arial bold 15
...
function Footer()
{
    ...
    $this->Line(10,$this->h-22, $this->w-10, $this->h-22);
	
	// $this->Cell(0,10,'Telefono: 664 679 143  •  Correo electronico: contablilidad@roure.es  •  Sitio web: http://www.roure.es/',0,0,'C');
	$this->Cell(0,10, $this->footer_content,0,0,'C');
	$this->Ln(5);
	// $this->Cell(0,10,'NIF: ESB42699256',0,0,'C');
	$this->Cell(0,10, $this->footer_nif,0,0,'C');
	$this->SetY(-15);
    // Arial italic 8
    $this->SetFont('Arial','',9);
    // Page number
...
function set_footer($content, $nif){
...
function addSociete( $nom, $adresse )
{
	...
	// $this->line($x1,$y1+22,$x1+30,$y1+22);
}
