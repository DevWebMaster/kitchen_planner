...
function render_input($name, $label = '', $value = '', $type = 'text', $input_attrs = [], $form_group_attr = [], $form_group_class = '', $input_class = '')
{
    ...
    if ($label != '') {
        $input .= '<label for="' . $name . '" class="control-label">' . trans($label, '', false) . '</label>';
    }
...
function render_textarea($name, $label = '', $value = '', $textarea_attrs = [], $form_group_attr = [], $form_group_class = '', $textarea_class = '')
{
    ...
    if ($label != '') {
        $textarea .= '<label for="' . $name . '" class="control-label">' . trans($label, '', false) . '</label>';
    }
 ...
 * @return string
 */
function render_select($name, $options, $option_attrs = [], $label = '', $selected = '', $select_attrs = [], $form_group_attr = [], $form_group_class = '', $select_class = '', $include_blank = true, $live_search = true)
{
    $callback_translate = '';
    ...
    if ($label != '') {
        $select .= '<label for="' . $name . '" class="control-label">' . trans($label, '', false) . '</label>';
    }
    $select .= '<select id="' . $name . '" name="' . $name . '" class="selectpicker' . $select_class . '" ' . $_select_attrs . ' data-live-search="'.$live_search.'">';
