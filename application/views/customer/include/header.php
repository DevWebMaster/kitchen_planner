                ...
                <div class="container clearfix">
                    ...
                    <div class="header-nav navbar-collapse collapse justify-content-end" id="navbarNavDropdown">
                        ...
                        <ul class="nav navbar-nav">	
                        	...
                        	<?php } ?>
                        	<?php if(!empty($this->session->userdata('is_customer_logged'))){ ?>
                        		<li><a href="http://localhost:8080/?customer_id=<?=$this->session->userdata('user_id'); ?>-0" target="blank">DISEÑAR COCINA   </a></li>
                        	<?php }else if(!empty($this->session->userdata('is_pos_logged'))){ ?>
                                <li><a href="http://localhost:8080/?pos_id=<?=$this->session->userdata('user_id'); ?>-0" target="blank">DISEÑAR COCINA   </a></li>
                            <?php }else{ ?>
