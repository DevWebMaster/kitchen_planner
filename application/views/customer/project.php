					...
					<div class="swiper-container">
						<div class="swiper-wrapper">
							<div class="swiper-slide">
								<div class="swiper-image swiper-bg" data-swiper-parallax-y="35%" style="background-image:url(<?= base_url(); ?>images/gallery/gallery-4/pic1.jpg)"></div>
								<div class="swiper-image">
									<div class="swiper-content">
										<h2 class="title">Acabados de Lujo </h2>
							...
							<div class="swiper-slide">
								<div class="swiper-image">
									<div class="swiper-content">
										<h2 class="title">Diseños Modernos </h2>
										<!-- <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent molestie nec nisl eget scelerisque. Quisque placerat suscipit eros, eu tincidunt tellus blandit vel. Donec pellentesque dapibus interdum. Mauris et tellus congue, rutrum neque a, varius felis.</p> -->
							...
							<div class="swiper-slide">
								<div class="swiper-image swiper-bg" data-swiper-parallax-y="20%" style="background-image:url(<?= base_url(); ?>images/gallery/gallery-4/pic3.jpg)"></div>
								<div class="swiper-image">
									<div class="swiper-content">
										<h2 class="title">Para los más clásicos </h2>
										<!-- <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent molestie nec nisl eget scelerisque. Quisque placerat suscipit eros, eu tincidunt tellus blandit vel. Donec pellentesque dapibus interdum. Mauris et tellus congue, rutrum neque a, varius felis.</p> -->
										<!-- <a href="project" class="btn outline outline-2 button-lg black btn-lg radius-xl btn-aware">View Project<span></span></a> -->
									</div>
								</div>
							...
							<div class="swiper-slide">
								<div class="swiper-image">
									<div class="swiper-content">
										<h2 class="title">Con todo lujo de detalles </h2>
										<!-- <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent molestie nec nisl eget scelerisque. Quisque placerat suscipit eros, eu tincidunt tellus blandit vel. Donec pellentesque dapibus interdum. Mauris et tellus congue, rutrum neque a, varius felis.</p> -->
										<!-- <a href="project" class="btn outline outline-2 button-lg black btn-lg radius-xl btn-aware">View Project<span></span></a> -->
									</div>
								</div>
							...
							<div class="swiper-slide">
								<div class="swiper-image swiper-bg" data-swiper-parallax-y="20%" style="background-image:url(<?= base_url(); ?>images/gallery/gallery-4/pic5.jpg)"></div>
								<div class="swiper-image">
									<div class="swiper-content">
										<h2 class="title">Sencillamente Expectacular </h2>
										<!-- <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent molestie nec nisl eget scelerisque. Quisque placerat suscipit eros, eu tincidunt tellus blandit vel. Donec pellentesque dapibus interdum. Mauris et tellus congue, rutrum neque a, varius felis.</p> -->
										<!-- <a href="project" class="btn outline outline-2 button-lg black btn-lg radius-xl btn-aware">View Project<span></span></a> -->
									</div>
								</div>
							...
							<div class="swiper-slide">
								<div class="swiper-image">
									<div class="swiper-content">
										<h2 class="title">Mezclando lo clásico con innovación </h2>
										<!-- <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent molestie nec nisl eget scelerisque. Quisque placerat suscipit eros, eu tincidunt tellus blandit vel. Donec pellentesque dapibus interdum. Mauris et tellus congue, rutrum neque a, varius felis.</p> -->
										<!-- <a href="project" class="btn outline outline-2 button-lg black btn-lg radius-xl btn-aware">View Project<span></span></a> -->
									</div>
								</div>
