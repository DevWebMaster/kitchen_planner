          ...
          <div class="card">
            <div class="card-body">
              <form method="post" enctype="multipart/form-data" id="uploadForm">
                <input type="hidden" name="edit_floor_texture_id" id="edit_floor_texture_id" value="<?= $floor_texture_id; ?>">
                <div class="col-md-12" style="display: inline-flex;">
                  ...
                  <div class="col-12 col-md-2">
                    <div class="form-group mt-4">
                      ...
                      <a href="<?= site_url(); ?>admin/menu_setting/floor_texture" type="button" class="btn btn-sm btn-info px-4">Back</a>
                    </div>
                  </div>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $('#uploadForm').submit(function(e) {
      e.preventDefault();
      if($('#edit_floor_texture_name').val()){
        var formData = new FormData(this);
        console.log(formData);
        $.ajax({
          url: '<?= site_url(); ?>admin/menu_setting/update_floor_texture',
          type: 'POST',
          data: formData,       
          cache: false,
          contentType: false,
        ...
        toastr.warning('Please select the image for the Floor texture.');
        return;
      }
