                ...
                <div class="col-md-12" style="display: inline-flex;">
                  <div class="col-12 col-md-2 offset-1">
                    <div class="form-group mb-2">
                      <label for="" class="control-label mb-1">POS Margin(%)</label>:
                  ...
                  <div class="col-12 col-md-2">
                    <div class="form-group mb-2">
                      <label for="" class="control-label mb-1">POS Customer Spread(EUR)</label>:
                  ...
                  <table id='margin_spread_list' class='table table-bordered table-striped text-center'>
                    <thead>
                      <tr>
                        <th>POS Name</th>
                        <th>POS Margin (%)</th>
                        <th>POS Spread (EUR)</th>
                        <th>POS Customer Margin (%)</th>
                        <th>POS Customer Spread (EUR)</th>
                        <th>Action</th>
                      </tr>
                    </thead>
                  </table>
