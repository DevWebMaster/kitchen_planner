  ...
  public function get_pos_orders()
    {
        ...
        foreach ($order_lists as $value) {
            ...
            if($value['check_flag'] == 1){
              $act_str = '<div style="display: inline-flex;"><a id="'.$value['product_id'].'" class="btn btn-design">3D Design</a><a href="'.base_url().$value['pdf_file'].'" target="_blank" style="color:white;" class="mr-1 btn-sm btn btn-info btn-pdf">Order</a><a style="color:white;" h_id="'.$value['id'].'" id="return'.$value['id'].'" class="mr-1 btn-sm btn btn-info btn-return">Return</a><a style="color:white;" h_id="'.$value['id'].'" id="remove'.$value['id'].'" class="btn-sm btn btn-info btn-remove">Remove</a></div>';
            }else if($value['check_flag'] == 2){
              $act_str = '<div style="display: inline-flex;"><a id="'.$value['product_id'].'" class="btn btn-design">3D Design</a><a href="'.base_url().$value['pdf_file'].'" target="_blank" style="color:white;" class="mr-1 btn-sm btn btn-info btn-pdf">Order</a><a style="color:white;" h_id="'.$value['id'].'" id="return'.$value['id'].'" class="mr-1 btn-sm btn btn-info btn-return">Return</a><a style="color:white;" h_id="'.$value['id'].'" id="remove'.$value['id'].'" class="btn-sm btn btn-info btn-remove">Remove</a></div>';
            }else if($value['check_flag'] == 0){
              $act_str = '<div style="display: inline-flex;"><a id="'.$value['product_id'].'" class="btn btn-design">3D Design</a><a style="color:white;" h_id="'.$value['id'].'" id="remove'.$value['id'].'" class="btn-sm btn btn-info btn-remove">Remove</a></div>';
            }
