...
(function ($) {
    ...
    var Datagrid = function (gcrud_container) {
        ...
        this.facadeInitListeners = function () {
            ...
            this.clearFilteringListener();
            this.listenerReadButton();
    ...
    Datagrid.prototype.clearFilteringCache = function () {
        var $searchAllInput = $('#search-input');
        console.log("test");
    ...
    Datagrid.prototype.datagridInit = function () {
        ...
        if (!success_message_container.is(':empty')) {
                           ...
                           success_message(success_message_container.html());
        }
    ...
    Datagrid.prototype.listenerReadButton = function () {

        if (dialog_forms) {
            $('.read-button, .add-button, .edit-button, .clone-button, .go-to-edit-form').unbind('click');
            $('.read-button, .add-button, .edit-button, .clone-button, .go-to-edit-form').click(function (event) {
    ...
    Datagrid.prototype.listenerExportButton = function () {
        ...
        $('.gc-export').click(function () {
            ...
            $('#tmp-form').remove();
            $('body').after($("<form/>").attr("id", "tmp-form").attr("method", "post").attr("target", "_blank").attr("action", export_url).html(form_inputs));
    ...
    Datagrid.prototype.SearchAndOrderingTrigger = function () {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                datagrid_object.listenerReadButton();
    ...
    Datagrid.prototype.clearFilteringListener = function clearFilteringListener($settingsContainer) {
        ...
        $('.clear-filtering').click(function clearFilteringClickButton() {
    ...
    Datagrid.prototype.listenerSearchButton = function () {
        ...
        $('.search-button').click(function (event) {
            ...
            //$('#search-input').addClass('search-input-big');

            setTimeout(function () {
                search_button.find('#search-input').focus();
            }, 400);
        ...
        $('#search-input').change(function () {
            $('.clear-all-search').remove();

            if ($(this).val() !== '') {
                $(this).after('<i class="fa fa-times clear-all-search"></i>');

                $('.clear-all-search').click(function () {
